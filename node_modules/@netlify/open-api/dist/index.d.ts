...
export interface paths {
  ...
  "/deploys/{deploy_id}/edge_functions/{code_sha}": {
    /** API Reference: {@link https://open-api.netlify.com/#tag/edgeFunction/operation/uploadDeployEdgeFunction | `uploadDeployEdgeFunction`} */
    put: operations["uploadDeployEdgeFunction"];
  };
...
export interface components {
  schemas: {
    ...
    deployFiles: {
       ...
       */
      edge_functions?: { [key: string]: unknown };
      function_schedules?: components["schemas"]["functionSchedule"][];
      functions_config?: {
    ...
    agentRunnerHookCreated: components["schemas"]["agentRunnerHook"] & {
      secret?: string;
    };
