...
export const resolveConfig = async function (opts) {
    ...
    const { config: configOpt, defaultConfig, inlineConfig, configMutations, configMutationsOrigin, cwd, context, repositoryRoot, base, branch, siteId, accountId, deployId, skewProtectionToken, buildId, baseRelDir, mode, debug, logs, featureFlags, } = await normalizeOpts(optsA);
 ...
 */
const loadConfig = async function ({ configOpt, cwd, context, repositoryRoot, packagePath, branch, defaultConfig, inlineConfig, configMutationsOrigin, baseRelDir, logs, featureFlags, }) {
 ...
 */
const getFullConfig = async function ({ configOpt, cwd, context, repositoryRoot, packagePath, branch, defaultConfig, inlineConfig, configMutationsOrigin, baseRelDir, configBase, base, logs, featureFlags, }) {
    ...
    try {
        ...
        const stage = configMutationsOrigin === undefined
