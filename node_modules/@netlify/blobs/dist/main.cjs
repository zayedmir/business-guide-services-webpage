...
var Client = class {
  ...
  async makeRequest({
    ...
    const usesSignedUrl = !this.edgeURL && key !== void 0 && storeName !== void 0 && method !== "head" /* HEAD */ && method !== "delete" /* DELETE */;
    let getRetryUrl;
    if (usesSignedUrl) {
      getRetryUrl = async () => {
...
var Store = class _Store {
  ...
  async set(key, data, options = {}) {
    return withSpan(options.span, "blobs.set", async (span) => {
      ...
      throw await createBlobsInternalError(res, { method: "put" /* PUT */, storeName: this.name });
    });
  }
