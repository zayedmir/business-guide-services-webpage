...
__export(main_exports, {
  BACKGROUND_FUNCTION_TIMEOUT: () => BACKGROUND_FUNCTION_TIMEOUT,
  SYNCHRONOUS_FUNCTION_TIMEOUT: () => SYNCHRONOUS_FUNCTION_TIMEOUT,
  builder: () => wrapHandler,
...
var SYNCHRONOUS_FUNCTION_TIMEOUT = 30;
var BACKGROUND_FUNCTION_TIMEOUT = 900;
...
var wrapHandler = (handler) => (event, context, callback) => {
...
var getOrCreateStore = () => {
  ...
  if (existing instanceof import_node_async_hooks.AsyncLocalStorage) {
    return existing;
  }
  const store = new import_node_async_hooks.AsyncLocalStorage();
  globalRef[STORE_KEY] = store;
  return store;
};
var contextStore = getOrCreateStore();

// src/lib/get_context.ts
var getContext = () => {
